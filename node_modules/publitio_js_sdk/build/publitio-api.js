...
function () {
  ...
  _createClass(PublitioAPI, [{
    ...
    value: function call(_call) {
      ...
      return _helper.helper.callApi(url, method).catch(function (error) {
        throw error;
      });
    }
  }, {
    ...
    value: function uploadFile(file) {
      ...
      return _helper.helper.uploadFile(file, url).catch(function (error) {
        throw error;
      });
    }
  }, {
    ...
    value: function uploadRemoteFile() {
      ...
      return _helper.helper.callApi(url, 'POST').catch(function (error) {
        throw error;
      });
    }
  }, {
